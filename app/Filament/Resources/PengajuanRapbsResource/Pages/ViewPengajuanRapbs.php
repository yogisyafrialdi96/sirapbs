...
class ViewPengajuanRapbs extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            // --- Pegawai: ajukan ulang setelah direvisi ---
            ...
            // --- Edit (hanya saat status bisa diedit) ---
            Actions\EditAction::make()
                ->label('Edit')
                ->visible(fn () => in_array($this->getRecord()->status, ['draft', 'direvisi'])),
